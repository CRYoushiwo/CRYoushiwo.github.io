...
## 时序系统
	...
	- <span style='color:red_background'>微操作流程（指令执行步骤）</span>
...
## 硬布线控制器设计
	...
	- <span style='color:red_background'>两级时序（产生节拍周期和CPU周期）</span>

	- 例题（x86控制单元为例） 

	![Untitled](7142502f_Untitled.png)
...
可变格式仅有地址域或控制域中的一种，指令长度最短，但增加了微程序的长度
		...
		- 控制域设计（编码）
			...
			- 水平型微指令控制域编码
				...
				<span style='color:red_background'>字段译码法</span>
